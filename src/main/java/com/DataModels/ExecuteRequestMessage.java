...
public final class ExecuteRequestMessage extends Message {

    @JsonProperty("content")
    private final ExecuteRequestContent content;

    @JsonCreator
    public ExecuteRequestMessage(@JsonProperty("content") final ExecuteRequestContent content,
    ...
    public ExecuteRequestContent getContent() {
        return this.content;
    }    
}
