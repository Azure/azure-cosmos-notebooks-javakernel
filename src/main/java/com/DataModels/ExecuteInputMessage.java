...
public final class ExecuteInputMessage extends Message {

    @JsonProperty("content")
    private final ExecuteInputContent content;

    @JsonCreator
    public ExecuteInputMessage(@JsonProperty("content") final ExecuteInputContent content,
    ...
    public ExecuteInputContent getContent() {
        return this.content;
    }    
}
