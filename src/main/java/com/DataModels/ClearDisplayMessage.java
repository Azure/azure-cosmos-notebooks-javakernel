...
public class ClearDisplayMessage extends Message {

    @JsonProperty("content")
    private final ClearDisplayContent content;    

    @JsonCreator
    public ClearDisplayMessage(@JsonProperty("content") final ClearDisplayContent content,
    ...
    public ClearDisplayContent getContent() {
        return this.content;
    }
