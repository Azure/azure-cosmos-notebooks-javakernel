...
public class KernelStatusMessage extends Message {

    @JsonProperty("content")
    private final KernelStatusContent content;    

    @JsonCreator
    public KernelStatusMessage(@JsonProperty("content") final KernelStatusContent content,
    ...
    public KernelStatusContent getContent() {
        return this.content;
    }
